...
-- CreateEnum
CREATE TYPE "QuizStatus" AS ENUM ('UPCOMING', 'ONGOING', 'COMPLETED');

-- CreateEnum
CREATE TYPE "AttemptStatus" AS ENUM ('IN_PROGRESS', 'SUBMITTED', 'CANCELLED');
...
CREATE TABLE "Quiz" (
    ...
    "status" "QuizStatus" NOT NULL DEFAULT 'UPCOMING',
...
CREATE TABLE "QuizAttempt" (
    ...
    "isPlagiarism" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
